...
""".strip(),
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            expect(page.get_by_role("button", name="Collapse layers")).to_be_visible()
            expect(page.get_by_text("No scene yet").first).to_be_visible()
            expect(page.get_by_text("No editable layers yet.")).to_be_visible()
            page.get_by_role("button", name="Collapse layers").click()
            expect(page.get_by_label("Scene layers rail")).to_have_class(re.compile("collapsed"))
            page.get_by_role("button", name="Expand layers").click()
            page.screenshot(path=str(output_dir / "studio-layers-rail-empty.png"), full_page=True)
            ...
            expect(page.get_by_text("Layer: ContextFace")).to_be_visible()
            ...
            expect(page.get_by_role("button", name="Attach layer Pips path")).to_be_visible()
            ...
            expect(page.get_by_role("button", name="Attach layer PrimaryMark path")).to_be_visible()
            expect(page.get_by_role("button", name="Attach layer Wordmark text")).to_be_visible()
            expect(page.get_by_role("button", name="Attach layer Face ellipse")).not_to_be_visible()
            ...
            expect(page.get_by_role("button", name="Attach layer ActiveSegment path")).to_be_visible()
            expect(page.get_by_role("button", name="Attach layer Track ellipse")).to_be_visible()
            expect(page.get_by_role("button", name="Attach layer Body ellipse")).not_to_be_visible()

            page.get_by_role("button", name="Mascot now").click()
            expect(page.get_by_text("Helpful Mascot / Helpful Mascot Motion")).to_be_visible()
            expect(page.get_by_role("button", name="Attach layer Body ellipse")).to_be_visible()
            expect(page.get_by_role("button", name="Attach layer Head ellipse")).to_be_visible()
            expect(page.get_by_role("button", name="Attach layer Eyes path")).to_be_visible()
