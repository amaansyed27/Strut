...
def run_smoke() -> None:
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            expect(page.get_by_text("AI-first motion design")).to_be_visible()
            ...
            expect(page.get_by_text("Smoke Mascot")).to_be_visible()
            expect(page.get_by_role("button", name="Chat")).to_be_visible()
            expect(page.get_by_role("button", name="Files")).to_be_visible()
            expect(page.get_by_role("button", name="Editor")).to_be_visible()
            expect(page.get_by_role("button", name="AI")).to_be_visible()
            ...
            expect(activity).to_have_text("Desktop app required for provider config")
            page.get_by_role("button", name="Test selected provider").click()
            expect(activity).to_have_text("Desktop app required for real provider checks")
            ...
            expect(page.get_by_role("button", name="starter.strut.json scene")).to_be_visible()
