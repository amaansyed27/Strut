...
def run_smoke() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            expect(page.get_by_role("button", name="BadgePlate ellipse")).to_be_visible()
            page.get_by_role("button", name="BadgePlate ellipse").click()
            expect(page.get_by_test_id("selected-part-inspector")).to_contain_text("badge base")
